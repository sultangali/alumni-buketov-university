...
export function Frame() {
  ...
  const frameStyle: CSSProperties = {
    ...
    borderRadius: narrow ? 40 : 16,
    overflow: 'hidden',
    background: '#05070c',
    border: narrow ? '12px solid #0b0f18' : '1px solid #2b3650',
  ...
  return (
    <div style={frameStyle} data-motion={motion}>
      ...
      {narrow && (
        ...
        >
          <div style={{ width: 7, height: 7, borderRadius: '50%', background: '#2b3650' }} />
          <div style={{ width: 46, height: 6, borderRadius: 999, background: '#1c2435' }} />
        </div>
      )}
      ...
      {narrow && (
        <div
          style={{
            height: 56,
            flex: '0 0 56px',
            background: 'linear-gradient(#0b0f18, #05070c)',
            display: 'flex',
            alignItems: 'center',
            justifyContent: 'center',
          }}
        >
          <div style={{ width: 120, height: 5, borderRadius: 999, background: '#1c2435' }} />
        </div>
      )}
    </div>
  )
