  ...
  return (
    <>
      ...
      <div style={{ display: 'flex', gap: 10, padding: '12px var(--pad)', borderTop: 'var(--bw) solid var(--c-line)' }}>
        ...
        <button style={{ ...navBtn, background: 'var(--c-primary)', color: '#fff', borderColor: 'var(--c-primary)', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', gap: 6 }} onClick={goHome}>
          <Icon name="home" size={18} /> {ui.kioskHome}
        </button>
        <button style={{ ...navBtn, display: 'inline-flex', alignItems: 'center', justifyContent: 'center', gap: 6 }} onClick={() => go({ name: 'apply' })}>
