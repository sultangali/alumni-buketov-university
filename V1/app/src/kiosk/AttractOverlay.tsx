  ...
  const renderFace = (person: Alumnus, isBack: boolean) => (
    <div style={faceStyle(person, isBack)}>
      <div style={{ position: 'absolute', inset: 0, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <span style={{ fontFamily: 'Lora, serif', fontWeight: 700, fontSize: 280, color: 'rgba(255,255,255,.16)', lineHeight: 1 }}>
      ...
      <div style={{ position: 'relative', padding: '0 var(--pad) 12%', color: '#fff', textAlign: 'center' }}>
        <div style={{ fontFamily: 'Lora, serif', fontWeight: 700, fontSize: 'var(--t-xl)', lineHeight: 1.12, marginBottom: 8, textWrap: 'balance' }}>
          {L(person.name)}
        </div>
