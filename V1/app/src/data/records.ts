...
export let FAC: Faculty[] = [
  {
    id: 'mit',
    est: 1972,
    grad: 'linear-gradient(140deg,#3a7bd5,#1E50A0)',
    abbr: 'МАТ',
    name: {
    ...
    depts: [
      ...
      },
      {
        ...
        est: 2003,
        count: 189,
        grad: 'linear-gradient(140deg,#4f8be0,#2a5fb0)',
      ...
      },
      {
        ...
        est: 1998,
        count: 212,
        grad: 'linear-gradient(140deg,#2f6bd0,#16407f)',
  ...
  },
  {
    id: 'phys',
    est: 1972,
    grad: 'linear-gradient(140deg,#8a6fd6,#5b3fb0)',
    abbr: 'ФТ',
    ...
    depts: [
      ...
      },
      {
        ...
        est: 1985,
        count: 142,
        grad: 'linear-gradient(140deg,#9b7ee0,#6a4cc0)',
  ...
  },
  {
    id: 'law',
    est: 1991,
    grad: 'linear-gradient(140deg,#cba24f,#9c7424)',
    abbr: 'ЗАҢ',
    ...
    depts: [
      ...
      },
      {
        ...
        est: 1994,
        count: 176,
        grad: 'linear-gradient(140deg,#d8b15a,#a87f2c)',
  ...
  },
  {
    id: 'phil',
    est: 1972,
    grad: 'linear-gradient(140deg,#3a9d86,#1f6f5d)',
    abbr: 'ФИЛ',
    ...
    depts: [
      ...
      },
      {
        ...
        est: 1989,
        count: 158,
        grad: 'linear-gradient(140deg,#43ab92,#27806b)',
  ...
  {
    id: 'biogeo', est: 1972, grad: 'linear-gradient(140deg,#3a7bd5,#1E50A0)', abbr: 'БГ',
    ...
    depts: [{ id: 'biogeo-d', est: 1972, count: 184, grad: 'linear-gradient(140deg,#3a7bd5,#1E50A0)', name: { ru: 'Биолого-географический' }, head: { ru: '—' }, hist: { ru: '' } }],
  },
  {
    id: 'history', est: 1938, grad: 'linear-gradient(140deg,#8a6fd6,#5b3fb0)', abbr: 'ИСТ',
    ...
    depts: [{ id: 'history-d', est: 1938, count: 156, grad: 'linear-gradient(140deg,#8a6fd6,#5b3fb0)', name: { ru: 'Исторический' }, head: { ru: '—' }, hist: { ru: '' } }],
  },
  {
    id: 'lang', est: 1989, grad: 'linear-gradient(140deg,#cba24f,#9c7424)', abbr: 'ИЯ',
    name: { kz: 'Шетел тілдері', ru: 'Иностранных языков', en: 'Foreign Languages' },
    ...
    depts: [{ id: 'lang-d', est: 1989, count: 203, grad: 'linear-gradient(140deg,#cba24f,#9c7424)', name: { ru: 'Иностранных языков' }, head: { ru: '—' }, hist: { ru: '' } }],
  },
  {
    id: 'edu', est: 1952, grad: 'linear-gradient(140deg,#3a9d86,#1f6f5d)', abbr: 'ПЕД',
    ...
    depts: [{ id: 'edu-d', est: 1952, count: 268, grad: 'linear-gradient(140deg,#3a9d86,#1f6f5d)', name: { ru: 'Педагогический' }, head: { ru: '—' }, hist: { ru: '' } }],
  },
  {
    id: 'sport', est: 1976, grad: 'linear-gradient(140deg,#3a7bd5,#1E50A0)', abbr: 'ФКС',
    ...
    depts: [{ id: 'sport-d', est: 1976, count: 142, grad: 'linear-gradient(140deg,#3a7bd5,#1E50A0)', name: { ru: 'Физической культуры и спорта' }, head: { ru: '—' }, hist: { ru: '' } }],
  },
  {
    id: 'philpsy', est: 1995, grad: 'linear-gradient(140deg,#8a6fd6,#5b3fb0)', abbr: 'ФП',
    ...
    depts: [{ id: 'philpsy-d', est: 1995, count: 118, grad: 'linear-gradient(140deg,#8a6fd6,#5b3fb0)', name: { ru: 'Философии и психологии' }, head: { ru: '—' }, hist: { ru: '' } }],
  },
  {
    id: 'chem', est: 1964, grad: 'linear-gradient(140deg,#cba24f,#9c7424)', abbr: 'ХИМ',
    ...
    depts: [{ id: 'chem-d', est: 1964, count: 137, grad: 'linear-gradient(140deg,#cba24f,#9c7424)', name: { ru: 'Химический' }, head: { ru: '—' }, hist: { ru: '' } }],
  },
  {
    id: 'econ', est: 1991, grad: 'linear-gradient(140deg,#3a9d86,#1f6f5d)', abbr: 'ЭК',
    ...
    depts: [{ id: 'econ-d', est: 1991, count: 224, grad: 'linear-gradient(140deg,#3a9d86,#1f6f5d)', name: { ru: 'Экономический' }, head: { ru: '—' }, hist: { ru: '' } }],
  },
  {
    id: 'distance', est: 2010, grad: 'linear-gradient(140deg,#3a7bd5,#1E50A0)', abbr: 'ЦДО',
    ...
    depts: [{ id: 'distance-d', est: 2010, count: 96, grad: 'linear-gradient(140deg,#3a7bd5,#1E50A0)', name: { ru: 'Центр дистанционного образования' }, head: { ru: '—' }, hist: { ru: '' } }],
  },
  {
    id: 'college', est: 1999, grad: 'linear-gradient(140deg,#8a6fd6,#5b3fb0)', abbr: 'КОЛ',
    ...
    depts: [{ id: 'college-d', est: 1999, count: 312, grad: 'linear-gradient(140deg,#8a6fd6,#5b3fb0)', name: { ru: 'Колледж' }, head: { ru: '—' }, hist: { ru: '' } }],
  },
  {
    id: 'extra', est: 2005, grad: 'linear-gradient(140deg,#cba24f,#9c7424)', abbr: 'ДО',
    ...
    depts: [{ id: 'extra-d', est: 2005, count: 74, grad: 'linear-gradient(140deg,#cba24f,#9c7424)', name: { ru: 'Дополнительного образования' }, head: { ru: '—' }, hist: { ru: '' } }],
  },
]
