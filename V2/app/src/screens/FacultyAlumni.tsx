        ...
        {list.map((a) => (
          ...
          >
            <div style={{ position: 'absolute', inset: 0, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <span style={{ fontFamily: 'var(--font-display)', fontWeight: 700, fontSize: 72, color: 'rgba(255,255,255,.20)', lineHeight: 1 }}>{initials(a.name)}</span>
            </div>
            ...
            <div style={{ position: 'absolute', left: 0, right: 0, bottom: 0, padding: 13, color: '#fff', display: 'flex', alignItems: 'flex-end', gap: 8 }}>
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                <div style={{ fontFamily: 'var(--font-display)', fontWeight: 700, fontSize: 'var(--t-base)', lineHeight: 1.15, marginBottom: 3, display: '-webkit-box', WebkitLineClamp: 2, WebkitBoxOrient: 'vertical', overflow: 'hidden' }}>{L(a.name)}</div>
