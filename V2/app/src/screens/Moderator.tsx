            ...
            drafts.map((d) => {
              ...
              return (
                ...
                >
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <div style={{ fontFamily: 'var(--font-display)', fontWeight: 700, color: 'var(--c-ink)', fontSize: 'var(--t-base)', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                      {dname}
                    </div>
                    <div style={{ color: 'var(--c-ink2)', fontSize: 'var(--t-2xs)', fontWeight: 600 }}>
        ...
        >
          ...
          >
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 18, gap: 12 }}>
              <h2 style={{ fontFamily: 'var(--font-display)', fontWeight: 700, color: 'var(--c-ink)', fontSize: 'var(--t-lg)', margin: 0 }}>
                {ui.editRecord}
              </h2>
              <button
                onClick={cancelEdit}
